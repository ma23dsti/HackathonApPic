...
from utilitaires.Selection_Parametre import selection_parametre, selection_variable, selection_donnee_export,selection_format_export
...
def show():
    ...
    with col3:
        #checkbox avec les 2 propositions (graphique et tableau des metriques)
        choix_donnees_export, donnees_prevision, donnees_kpi=selection_donnee_export() 
        
    with col4:
        #chexkbox avec les differents formats
        choix_format_export=selection_format_export()
